...
exports.getAdaptiveSettings = getAdaptiveSettings;
exports.performanceHandler = performanceHandler;
exports.resetMetrics = resetMetrics;
exports.autoOptimizeMiddleware = autoOptimizeMiddleware;
...
function getAdaptiveSettings(req) {
...
function performanceHandler(req, res) {
    try {
        const metrics = getCurrentMetrics();
...
function generateRecommendations(metrics, adaptive) {
...
function autoOptimizeMiddleware() {
    return (req, res, next) => {
        const adaptive = getAdaptiveSettings(req);
        // Aplicar otimizações automáticas
        if (adaptive.shouldThrottle && req.adaptiveConfig) {
            req.adaptiveConfig.pagination.messageLimit = Math.min(req.adaptiveConfig.pagination.messageLimit, adaptive.recommendedLimit);
            req.adaptiveConfig.timeouts.sseTimeout = Math.min(req.adaptiveConfig.timeouts.sseTimeout, adaptive.recommendedTimeout);
