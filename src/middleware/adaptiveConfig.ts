...
import { DeviceContext } from './deviceDetector'
...
const CONFIG_PRESETS: Record<string, Partial<AdaptiveConfig>> = {
  'mobile-slow': {
...
// Extend Express Request to include adaptive config
declare global {
  namespace Express {
    interface Request {
...
export function adaptiveConfig(req: Request, res: Response, next: NextFunction) {
